...
> *ᴅᴇᴅɪᴄᴀᴛᴇᴅ ᴛᴏ Fᴀʀɪᴅᴀʜ🧝*`
                ...
                message: {
                  ...
                  interactiveMessage: proto.Message.InteractiveMessage.create({
                    ...
                    header: proto.Message.InteractiveMessage.Header.create({
                      ...
                      ...await prepareWAMessageMedia({ image: VeronWlcm }, { upload: nexwrldmd.waUploadToServer })
                    }),
            ...
            let VeronName = num
            const Veronmembers = metadata.participants.length
            Veronbody = `
   ╭────❒ 𝗚𝗼𝗼𝗱𝗯𝘆𝗲 👋 ❒
   ├─∘❏◈ @${VeronName.split("@")[0]}  」
   ├─∘❏◈  𝗟𝗲𝗳𝘁 
              ...
              viewOnceMessage: {
                message: {
                  ...
                  interactiveMessage: proto.Message.InteractiveMessage.create({
                    ...
                    header: proto.Message.InteractiveMessage.Header.create({
                      hasMediaAttachment: false,
                      ...await prepareWAMessageMedia({ image: VeronLft }, { upload: nexwrldmd.waUploadToServer })
                    }),
                    nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
                      buttons: [{
                        "name": "quick_reply",
      ...
      try {
        ...
        for (let num of participants) {
          ...
          if (anu.action == 'promote') {
            ...
            const Verondate = moment.tz('Africa/Kampala').format('DD/MM/YYYY')
            let VeronName = num
            Veronbody = `𝗢𝗼𝗽𝘀‼️ @${VeronName.split("@")[0]}, you have been *demoted* from *admin* 😬`
            nexwrldmd.sendMessage(anu.id,
              { text: Veronbody,
                contextInfo:{
                  mentionedJid:[num],
